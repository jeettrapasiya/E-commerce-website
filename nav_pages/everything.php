...
<body>
  <div class="navbar">
    <a href="http://localhost/E-commerce--main/home.php">
    ...
    <div class="nav-item-left">
      ...
      <a class="text-decoration-none" href="http://localhost/E-commerce--main/nav_pages/everything.php">WOMEN</a>
      <a class="text-decoration-none" href="http://localhost/E-commerce--main/nav_pages/everything.php">MEN</a>
      <a class="text-decoration-none" href="http://localhost/E-commerce--main/nav_pages/everything.php">ACCESSORIES</a>
    </div>

    <div class="nav-item-right">
      <a href="http://localhost/E-commerce--main/nav_pages/about.php" class="text-decoration-none">ABOUT</a>
      <a class="text-decoration-none" href="http://localhost/E-commerce--main/nav_pages/contact.php">CONTACTUS</a>
  ...
  <div class="containor">
    ...
    <div class="rightside">
      ...
      <?php
      require 'C:\xampp\htdocs\E-commerce--main\config.php';
