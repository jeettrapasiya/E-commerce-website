    ...
    <div class="conteiner" id="home">
      ...
      <header class="d-flex flex-row">
        ...
        <div class="nav-item-left">
          <a href="http://localhost/E-commerce--main/nav_pages/everything.php" class="active ">EVERYTHING</a>
          <a href="http://localhost/E-commerce--main/nav_pages/everything.php">WOMEN</a>
          <a href="http://localhost/E-commerce--main/nav_pages/everything.php">MEN</a>
          <a href="http://localhost/E-commerce--main/nav_pages/everything.php">ACCESSORIES</a>
        </div>

        <div class="nav-item-right">
          <a href="http://localhost/E-commerce--main/nav_pages/about.php" class="active">ABOUT</a>
          <a href="http://localhost/E-commerce--main/nav_pages/contact.php">CONTACTUS</a>
